...
class DNAApp:
    ...
    def create_widgets(self):
            ...
            main_frame.columnconfigure(1, weight=4, uniform="col")
            ...
            self.toggle_button = ttk.Button(
                self.left_frame,
                text="Ukryj motywy ▲",
                command=self.toggle_motif_list
            )
            self.toggle_button.pack(anchor="w", pady=5)

            self.motif_frame = ttk.Frame(self.left_frame)
            self.motif_frame.pack(fill="x")
            ...
            #==================================================================================
            # ===== WYSZUKIWARKA motywów w ramce =====
            self.search_var = tk.StringVar()

            ttk.Label(self.motif_frame, text="Szukaj motywu:").pack(anchor="w")
            ...
            self.search_var.trace_add("write", self.filter_motifs)
            ...
            ttk.Label(self.motif_frame, text="Motywy DNA\n kliknij aby zaznaczyć wiele", font=("Segoe UI", 12, "bold")).pack(anchor="w")

            self.motif_listbox = tk.Listbox(self.motif_frame, selectmode="multiple", height=8)
            self.motif_listbox.pack(fill="x", pady=5)
            self.all_motifs = list(MOTIF_DESCRIPTIONS.keys())
